...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/10.jpg" alt="Easy Transfer" width="1100" height="500">
      <div class="carousel-caption">
    <h3>Easy Money Transfer</h3>
    </div>
    </div>
    <div class="carousel-item">
      <img src="images/11.jpg" alt="Quick Deposit" width="1100" height="500">
...
<div class="py-5">
 ...
 <h1 class="text-center" >Apna Bank</h1>
 </div>

<div class="container-fluid">
 <div class ="row">
<div  class="col-lg-6 col-md-6 col-12">
   <img src="images/9.jpg" alt="Low interests" width="1550" height="600">
      </div>
...
<footer class="text-center mt-2 py-5">
        <p> <b>Abhishek sakpal</b> </br>Apna bank</p>
      </footer>
